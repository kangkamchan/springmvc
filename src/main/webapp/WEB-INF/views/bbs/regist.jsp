                        ...
                        <table class="table">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-3">
                                            <input type="date" class="form-control" id="displayDate" name="displayDate"/>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="mb-3">
                                            ...
                                            <button class="btn btn-primary mb-3" id="btnBack">목록으로</button>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
...
<script>
    ...
    <c:if test="${not empty errors}">
        <c:forEach items="${errors}" var="err">
            ...
            serverValidateResult['${err.field}'] = '${err.defaultMessage}';
        </c:forEach>
    </c:if>
    console.log(serverValidateResult);
</script>
</body>
</html>